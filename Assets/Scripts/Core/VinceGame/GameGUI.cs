...
namespace Core.VinceGame
{
    public class GameGUI : MonoBehaviour
    {
        ...
        private Dictionary<TextType, TMP_Text> _textElements;

        [Header("Game End UI")]
        [SerializeField] private Image[] myGridImages = new Image[9];
        [SerializeField] private Image[] opponentGridImages = new Image[9];
        public Image[] MyGridImages => myGridImages;
        public Image[] OpponentGridImages => opponentGridImages;
        ...
        // // Board positions
        // private Vector2 LeftPosition => new Vector2(-250f, 0f);
        // private Vector2 RightPosition => new Vector2(250f, 0f);
        // private Vector2 CenterPosition => new Vector2(0f, 0f);
        // private Vector2 OffscreenPosition => new Vector2(1000f, 0f);
        #endregion
        ...
        private void Awake()
        {
            ...
            _textElements = new Dictionary<TextType, TMP_Text>
            {
                { TextType.PlayerName, playerNameText },
                { TextType.PlayerTurn, playerTurnText },
                { TextType.OpponentTurn, opponentTurnText },
                { TextType.CurrentRound, currentRoundText },
                { TextType.Announcement, announcementText },
                { TextType.GameOver, gameOverText },
                { TextType.PlayerScore, playerScoreText },
                { TextType.OpponentScore, opponentScoreText },
                { TextType.PlayAgain, playAgainText },
                { TextType.Countdown, countdownText }
            };
        }
        ...
        public TMP_Text GetText(TextType textType)
        {
            return _textElements.GetValueOrDefault(textType);
        }
        ...
        public void ChangeOpponentButtonColor(int buttonIndex, string hexColor)
        {
            if (ColorUtility.TryParseHtmlString(hexColor, out Color color))
            {
        ...
        public void UpdateTurnIndicators(bool isMyTurn)
        {
            ...
            opponentTurnText.text = isMyTurn ? "Waiting..." : "Opponent's Turn";
        ...
        public void ShowMatchFoundScreen(string message)
        {
            LerpCanvasGroup(mainPage, 0);
            LerpCanvasGroup(readyPage, 1);
            _gameManager.TextAnimations.Typewriter(GetText(TextType.Countdown), message);
        }
        #endregion
