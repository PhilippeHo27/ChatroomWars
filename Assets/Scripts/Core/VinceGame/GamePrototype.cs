...
namespace Core.VinceGame
{
    public class GamePrototype : MonoBehaviour
    {
        ...
        private void StartGame(bool isMyTurn)
        {
            ...
            if (_isMyTurn) _gameManager.TextAnimations.PopText(gameGUI.GetText(TextType.PlayerTurn), "You start!");
            else _gameManager.TextAnimations.Typewriter(gameGUI.GetText(TextType.PlayerTurn), "Waiting...");
        ...
        private void ResetGame()
        {
            ...
            _gameManager.TextAnimations.Typewriter(gameGUI.GetText(TextType.Countdown), "Press Ready to go again");
        ...
        // INSIDE OF NETWORK.CS
        // private void SendImmuneStatus(byte index)
        // {
